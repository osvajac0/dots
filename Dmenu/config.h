...
{
	"SF Pro Display:style=Bold:size=12"
};
#endif // PANGO_PATCH
#if MANAGED_PATCH
...
char *colors[][2] = {
	/*               fg         bg       */
	[SchemeNorm] = { "#606060", "#0f0f0f" },
	[SchemeSel]  = { "#eeeeee", "#0f0f0f" },
	[SchemeOut]  = { "#0f0f0f", "#0f0f0f" },
	#if BORDER_PATCH
	[SchemeBorder] = { "#0f0f0f", "#0f0f0f" },
	#endif // BORDER_PATCH
	#if MORECOLOR_PATCH
	[SchemeMid]  = { "#eeeeee", "#770000" },
	#endif // MORECOLOR_PATCH
	#if HIGHLIGHT_PATCH
	[SchemeSelHighlight]  = { "#cc4545", "#0f0f0f" },
	[SchemeNormHighlight] = { "#3c5958", "#0f0f0f" },
	#endif // HIGHLIGHT_PATCH
	#if HIGHPRIORITY_PATCH
...
static unsigned int border_width = 22;
#endif // BORDER_PATCH
